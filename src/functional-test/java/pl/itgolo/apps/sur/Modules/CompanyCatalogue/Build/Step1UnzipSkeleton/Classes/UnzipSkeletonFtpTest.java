 ...
 */
public class UnzipSkeletonFtpTest extends WithBrowserTest implements IWithBrowserTest {
     ...
     */
    public UnzipSkeletonFtpTest(Browser browser, TemporaryFolder temporaryFolder) throws Exception {
    ...
    public void test() throws Exception {
        ...
        File skeletonZipFile = new File("C:\\Users\\ITGolo\\Desktop\\Szkielet Ten\\skeletonSur.zip"); //createTempSkeletonZipFile();
        IStepCompanyCatalogue unzipSkeletonFtp = new UnzipSkeletonFtp(
