 ...
 */
public class SeoConfigWordpressTest extends WithBrowserTest implements IWithBrowserTest {
     ...
     */
    public SeoConfigWordpressTest(Browser browser, TemporaryFolder temporaryFolder) throws Exception {
    ...
    public void test() throws Exception {
        ...
        IStepCompanyCatalogue seoConfigWordpress = new SeoConfigWordpress(
