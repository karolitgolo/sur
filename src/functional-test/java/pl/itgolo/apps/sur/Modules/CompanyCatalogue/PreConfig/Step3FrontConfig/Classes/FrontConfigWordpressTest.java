 ...
 */
public class FrontConfigWordpressTest extends WithBrowserTest implements IWithBrowserTest {
     ...
     */
    public FrontConfigWordpressTest(Browser browser, TemporaryFolder temporaryFolder) throws Exception {
    ...
    public void test() throws Exception {
        ...
        IStepCompanyCatalogue frontConfigWordpress = new FrontConfigWordpress(
