 ...
 */
public class StatConfigAnalyticsTest extends WithBrowserTest implements IWithBrowserTest {
     ...
     */
    public StatConfigAnalyticsTest(Browser browser, TemporaryFolder temporaryFolder) throws Exception {
    ...
    public void test() throws Exception {
        ...
        IStepCompanyCatalogue statConfigAnalytics = new StatConfigAnalytics(
