package pl.itgolo.apps.sur.Modules.Commons.Logger.Services;

import javafx.beans.property.ObjectProperty;
import javafx.beans.property.SimpleObjectProperty;
import pl.itgolo.apps.sur.Modules.Commons.Logger.Classes.Log;
...
public class LogService {
    ...
    public static void test(String message) {
        synchronized (LogService.class){
            Log log = new Log(Log.Level.TEST, message, getCallerClassName(), getCallerMethodName(), getCallerLineNumber());
            logProperty.set(log);
            callLogOut(log);
        }
    }
